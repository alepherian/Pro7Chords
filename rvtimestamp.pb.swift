...
struct RVData_Timestamp: Sendable {
...
extension RVData_Timestamp: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: RVData_Timestamp, rhs: RVData_Timestamp) -> Bool {
